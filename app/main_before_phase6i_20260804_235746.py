...
NAV_ITEMS = [
    ...
    ("mobile-app", "/mobile-app", "▯", "Install mobile app"),
...
register_pwa_routes(app, page_shell=page_shell, current_user=current_user)
...
def playback() -> str:
    ...
    content = f'''<header class="topbar"><div><p class="eyebrow">Live and recorded video</p><h1>Monitor</h1><p class="health-detail">Live cameras above · timeline always visible below</p></div></header>
