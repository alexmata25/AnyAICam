...
# Event-clip direct fetch has moved to main.py (the real, integrated
# customer route extending /api/customer/events/{camera_id}/{event_id}/
# media/url) -- see test_event_media_direct_wireguard.py.
