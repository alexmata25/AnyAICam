...
def register_partner_workspace_routes(app: FastAPI, shell: Callable) -> None:
    ...
    def list_customer_cameras(request: Request) -> dict:
        identity=customer_owner(request)
