...
### Phase 6e result — idle-relay auto-stop, concurrency/idempotency hardening, observability, IMPLEMENTED, TESTED, AND COMMITTED (NOT YET PUSHED) (2026-08-16)
...
**Committed as `bc39bb0`** ("Phase 6e: idle-relay auto-stop, concurrency hardening, observability"). **Not yet pushed.**

### Phase 6f result — per-appliance live-relay pilot gating, IMPLEMENTED, TESTED, AND COMMITTED (NOT YET PUSHED) (2026-08-16)
...
**Committed as `1d5722a`** ("Phase 6f: per-appliance live-relay pilot gating"). **Not yet pushed.**
...
**Current state: HOLD.** No further AWS investigation, CloudFront work, implementation, repository changes, or deployment work is authorized until an explicit new go-ahead.
